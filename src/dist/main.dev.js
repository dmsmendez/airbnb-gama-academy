...
var API_URL = "https://api.sheety.co/30b6e400-9023-4a15-8e6c-16aa4e3b1e72"; // Para isso, usaremos o "fetch", conforme você deve ter visto nas aulas online.
...
fetch(API_URL).then(function (response) {
  ...
  var data = JSON.parse(result); // Como é mesmo que percorremos um array? 'hm
  ...
  data.map(function (element) {
    ...
    var photo = element.photo,
        ...
        name = element.name,
        price = element.price; // Pegue a linha do container onde serão exibidos os cards.

    var row = document.getElementById("row"); // Agora, crie um elemento "div" com a class "col-md-4" do Bootstrap.

    var div = document.createElement("div");
    div.className = "col-md-4"; // Boa! Agora, precisamos criar a "div" do card a ser exibido. Ao criar, atribua a class "card mb-4 box-shadow".

    var card = document.createElement("div");
    card.className = "card mb-4 box-shadow"; // Humm... Agora que já temos o card, que tal começarmos a popular as informações?
    ...
    img.src = photo; // Legal! Agora, já podemos começar a construir o "corpo" do card. Bora lá!
    // Obs.: atribua a class "card-body" do Bootstrap, para que fique bonitão. :)

    var cardBody = document.createElement("div");
    cardBody.className = "card-body"; // Beleza, corpo criado. Seguindo nossa estrutura, o próximo elemento seria os textos, para exibir
    ...
    cardText.className = "card-text"; // Uffa! Finalmente os elementos da proriedade!
    ...
    propertyPrice.innerHTML = "Total de R$ ".concat(price, "."); // AOBA! Temos agora, todos os elementos necessários para percorrer a resposta da API e,
